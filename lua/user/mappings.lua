...
map("c", "<C-h>", "<Left>", {desc = "Movement Left"}, s_opts)
map("c", "<C-l>", "<Right>", {desc = "Movement Right"},  s_opts)

-- Duplicate line
map("n", "<M-d>", "<cmd>t.<CR>", {desc = "Duplicate line"},s_opts)
map("i", "<M-d>", "<Esc><cmd>t.<CR>gi", {desc = "Duplicate line"}, s_opts)
...
-- Toggle wrap
map("n", "<F11>", "<cmd>setlocal linebreak! wrap!<CR>" , {desc = "Toggle wrap"}, s_opts)
...
map("n", "<Leader>c", "<cmd>bp | sp | bn | bd<CR>", {desc = "Close window without changing layout"}, s_opts)

-- Enter normal mode in terminal
map("t", "<Esc>", "<C-\\><C-n>", s_opts)

-- Center cursor after traversing search
map("n", "n", "nzz", {desc = "Center cursor after traversing search"}, s_opts)
map("n", "N", "Nzz", {desc = "Center cursor after traversing search"}, s_opts)

-- Toggle fold (single level)
map("n", "<Space>", "foldlevel('.') ? 'za' : '<Space>'", {desc = "Toggle fold (single level)"}, se_opts)
...
map("n", "<C-M-s>", "<cmd>wall!<CR>", {desc = "save all buffer"}, se_opts)
map("n", "<C-x>", "<cmd>q<cr>", {desc = "Quit"}, se_opts)
map("n", "<C-M-q>", "<cmd>qall!<CR>", {desc = "Quit all"}, se_opts)
